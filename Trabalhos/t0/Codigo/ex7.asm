...
; pede para o usuário adivinhar um número aleatório
...
TELA    DEFINE 6
TELAOK  DEFINE 7
D_ALEATORIO DEFINE 18

LIMPA   DEFINE 10 ; \n, limpa a linha

         chama gera_aleatorio      ; Gera o número aleatório
         cargi str1
         chama escstr
laco     chama lechute
         chama vechute
...
; Função para gerar o número aleatório e armazená-lo no segredo
gera_aleatorio espaco 1
         le D_ALEATORIO             ; Lê o número aleatório
         armm segredo               ; Armazena o valor em 'segredo'
         ret gera_aleatorio
...
chute    espaco 1
segredo  espaco 1      ; Aqui será armazenado o número aleatório
